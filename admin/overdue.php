        ...
        <div class="container-fluid py-4">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">Track overdue assets and ensure timely resolution. Monitor overdue returns,
                        maintenance, or updates to keep your inventory up-to-date.</p> -->
                </div>
            </div>
