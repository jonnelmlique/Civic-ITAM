            ...
            <table class="table table-hover table-striped shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>2024-12-01</td>
                        <td>
                            <button class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#viewPCModal">View</button>
                            <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editPCModal">Edit</button>
                            <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#reportPCModal">Report Issue</button>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="editPCSpecs" rows="3">16GB RAM, Intel i7, 512GB SSD</textarea>
                    </div>
...
<div class="modal fade" id="reportPCModal" tabindex="-1" aria-labelledby="reportPCModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-orange text-white">
            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="issueDescription" rows="4" placeholder="Provide details about the issue"></textarea>
                    </div>
...
<div class="modal fade" id="requestPCModal" tabindex="-1" aria-labelledby="requestPCModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-orange text-white">
            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="requestPCName" placeholder="Enter the name of the PC you need">
                    </div>
                    <div class="mb-3">
                        <label for="requestPCSpecs" class="form-label">Specifications</label>
                        <textarea class="form-control" id="requestPCSpecs" rows="3" placeholder="Enter the desired specifications"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="requestPCReason" class="form-label">Reason for Request</label>
                        <textarea class="form-control" id="requestPCReason" rows="3" placeholder="Explain why you need this PC"></textarea>
                    </div>
