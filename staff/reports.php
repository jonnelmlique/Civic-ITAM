...
<body>
    ...
    <div id="sidebar" class="col-12 col-md-3 col-lg-2 px-0 bg-orange text-white">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="./schedule.php" class="nav-link text-white"><i class="bi bi-receipt-cutoff"></i>
                    Schedule</a></li>
            <li><a href="./reports.php" class="nav-link text-white active"><i class="bi bi-file-earmark-text"></i>
                    Reports</a>
            </li>
            <li><a href="./diagnostichistory.php" class="nav-link text-white"><i class="fas fa-history"></i>
            ...
            <div class="container-fluid py-4">
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <p class="text-muted">Below is a list of your submitted reports. You can also submit new reports
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">View your past reports. You can submit new reports or update existing
                            ones.</p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                            ...
                                            onclick="fillReportForm('2024-11-25', 'Weekly Progress Report', 'Submitted', 'This is the progress report for the week...')">Update</button>
                                        <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                            data-bs-target="#submitReportModal"
                                            onclick="setReportDetails('2024-11-25', 'Weekly Progress Report')">Submit
                                            New Report</button>
                                    </td>
                                </tr>
                ...
                <div class="modal fade" id="submitReportModal" tabindex="-1" aria-labelledby="submitReportModalLabel"
                    aria-hidden="true">
                                ...
                                <form id="submitReportForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="reportContent" rows="3"
                                            placeholder="Write your report content..." required></textarea>
                                    </div>
                ...
                <div class="modal fade" id="updateReportModal" tabindex="-1" aria-labelledby="updateReportModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header bg-orange text-white">
                            ...
                            <div class="modal-body">
                                <form id="updateReportForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="updateReportContent" rows="3"
                                            required></textarea>
                                    </div>
                                    <div class="mb-3">
