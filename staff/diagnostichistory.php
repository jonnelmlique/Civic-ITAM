...
<body>
    ...
    <div id="sidebar" class="col-12 col-md-3 col-lg-2 px-0 bg-orange text-white">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="./diagnostichistory.php" class="nav-link text-white active"><i class="fas fa-history"></i>
        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">Below is the history of all your previous transactions (e.g., asset requests,
                        tickets submitted, and schedule changes).</p> -->
                </div>
            </div>
