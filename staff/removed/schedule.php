    ...
    <div id="sidebar" class="col-12 col-md-3 col-lg-2 px-0 bg-orange text-white">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="./tickets.php" class="nav-link text-white"><i class="bi bi-ticket-perforated"></i>
                    Tickets</a></li>
            <li><a href="./schedule.php" class="nav-link text-white active"><i class="bi bi-receipt-cutoff"></i>
                    Schedule</a></li>
        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">Below is a list of your assigned assets. You can set or update the schedule
                        for each asset.</p> -->
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                        data-bs-target="#scheduleAssetModal"
                                        onclick="setAssetSchedule('PC-001', '2024-12-10')">Set Schedule</button>
                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#updateScheduleModal"
                                        onclick="fillScheduleForm('PC-001', '2024-12-10')">Update Schedule</button>
                                </td>
                            </tr>
                            <tr>
                                <td>Monitor-005</td>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                        data-bs-target="#scheduleAssetModal"
                                        onclick="setAssetSchedule('Monitor-005', '2024-12-12')">Set Schedule</button>
                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#updateScheduleModal"
                                        onclick="fillScheduleForm('Monitor-005', '2024-12-12')">Update Schedule</button>
                                </td>
                            </tr>
            ...
            <div class="modal fade" id="scheduleAssetModal" tabindex="-1" aria-labelledby="scheduleAssetModalLabel"
                aria-hidden="true">
