...
<body>
    ...
    <div id="sidebar" class="col-12 col-md-3 col-lg-2 px-0 bg-orange text-white">
        ...
        <ul class="nav flex-column">
            ...
            <li><a href="./managerequest.php" class="nav-link text-white active"><i class="bi bi-person"></i> Manage
                    requests</a></li>
        </ul>
    </div>
    <div id="content">
        ...
        <div class="container-fluid py-4">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">Below you can view and manage all your asset requests. You can see the status,
                        edit, or cancel your requests.</p> -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                        data-bs-target="#viewRequestModal">View</button>
                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#editRequestModal">Edit</button>
